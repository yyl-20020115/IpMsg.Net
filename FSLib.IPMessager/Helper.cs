...
public static class Helper
{
	...
	public class HostSubEqualityCompare : IEqualityComparer<Host>
	{
        ...
        public bool Equals(Host x, Host y) => x.HostSub.IPHeader == y.HostSub.IPHeader;
        ...
        /// <returns></returns>
        public int GetHashCode(Host obj) => obj.GetHashCode();
	...
	public static string ToSizeDesc(this ulong size)
	{
        ...
        return size < d
            ...
            : size < 0x400 * d
            ? $"{size / 1024.0:#0.0} KB"
            : size < 0x100000 * d ? $"{size / 1048576.0:#0.0} MB" : $"{size / (0x40000000 * 1.0):#0.0} GB";
    }
