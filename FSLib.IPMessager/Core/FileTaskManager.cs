...
public class FileTaskManager : IDisposable
{
	...
	protected virtual void OnSendTaskAdded(FileTaskEventArgs e)
	{
		...
		{
			_spcSendTaskAdded ??= (s) => SendTaskAdded(this, s as FileTaskEventArgs);
	...
	protected virtual void OnSendTaskFinished(FileTaskEventArgs e)
	{
		...
		{
			spcSendTaskFinished ??= (s) => SendTaskFinished(this, s as FileTaskEventArgs);
	...
	protected virtual void OnSendItemStart(FileTaskEventArgs e)
	{
		...
		{
			spcSendItemStart ??= (s) => SendItemStart(this, s as FileTaskEventArgs);
	...
	protected virtual void OnTaskItemStateChanged(FileTaskEventArgs e)
	{
		...
		{
			spcTaskItemStateChanged ??= (s) => TaskItemStateChanged(this, s as FileTaskEventArgs);
	...
	protected virtual void OnTaskItemProgressChanged(FileTaskEventArgs e)
	{
		...
		{
			spcTaskItemProgressChanged ??= (s) => TaskItemProgressChanged(this, s as FileTaskEventArgs);
	...
	{
		if (!SendTask.TryGetValue(packageId, out FileTaskInfo value) || taskIndex < 0)
			return null;

		lock (SendTask)
		{
			FileTaskInfo fti = value;
	...
	protected virtual void OnReceiveTaskAdded(FileTaskEventArgs e)
	{
		...
		{
			spcReceiveTaskAdded ??= (s) => ReceiveTaskAdded(this, s as FileTaskEventArgs);
	...
	protected virtual void OnReceiveTaskFinished(FileTaskEventArgs e)
	{
		...
		{
			spcReceiveTaskFinished ??= (s) => ReceiveTaskFinished(this, s as FileTaskEventArgs);
	...
	protected virtual void OnReceiveItemStart(FileTaskEventArgs e)
	{
		...
		{
			spcReceiveItemStart ??= (s) => ReceiveItemStart(this, s as FileTaskEventArgs);
	...
	{
        FileReceiveRequired?.Invoke(this, e);
    }
	...
	{
        FileReceiveRequiring?.Invoke(this, e);
    }
	...
	protected virtual void OnFileReceiveTaskReDroped(FileTaskEventArgs e)
	{
		...
		{
			callFileReceiveTaskReDroped ??= s => FileReceiveTaskReDroped(this, s as FileTaskEventArgs);
	...
	protected virtual void OnFileReceiveTaskDiscarded(FileTaskEventArgs e)
	{
		...
		if (IPMClient.NeedPostMessage)
		{
			callFileReceiveTaskDiscarded ??= s => FileReceiveTaskDiscarded(this, s as FileTaskEventArgs);
	...
	public void CancelReceiveTask(ulong packageId, int index)
	{
        ...
        void itemMarker(FileTaskItem s)
        {
	...
	protected virtual void OnTaskExpires(FileTaskEventArgs e)
	{
		...
		{
			_spcTaskExpires ??= (f) => TaskExpires(this, f as FileTaskEventArgs);
	...
	protected virtual void OnReleaseFileRequired(FileTaskEventArgs e)
	{
		...
		{
			cbReleaseFileReuired ??= s => ReleaseFileRequired(this, s as FileTaskEventArgs);
