...
public class Config
{
    ...
    {
        get => string.IsNullOrEmpty(_hostName) ? Environment.MachineName : _hostName;
        set => _hostName = value;
    }
    ...
    {
        get => string.IsNullOrEmpty(_hostUserName) ? Environment.UserName : _hostUserName;
    ...
    {
        get => string.IsNullOrEmpty(_nickName) ? this.HostUserName : _nickName;
        set => _nickName = value;
    }
    ...
    {
        get => string.IsNullOrEmpty(_groupName) ? this.HostName : _groupName;
    ...
    {
        get => BindedIP.ToString();
        set => BindedIP = IPAddress.Parse(value);
    }
    ...
    /// </summary>
    /// <returns></returns>
    public static ulong GetRandomTick() => (ulong)((new Random()).Next()) + (packageIndex++);
